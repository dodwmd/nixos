{
  ...
  # WiFi credentials stored as agenix secret deployed as NM keyfile
  # To create: see secrets/wifi-something.age instructions
  age.secrets.wifi-something-nmconn = {
    file = ../../secrets/wifi-something.age;
    path = "/etc/NetworkManager/system-connections/Something.nmconnection";
    mode = "0600";
    owner = "root";
  };
