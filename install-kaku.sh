...
nix-shell -p nixVersions.stable git --run "
    ...
    print_color 'green' 'Step 9: Installing NixOS with the dotfiles'
    cd /mnt/etc/nixos/
...
print_color "yellow" "\nAfter rebooting, you should change your password with:"
print_color "yellow" "  passwd YourUser"
print_color "yellow" "\nThen install Home Manager configuration with:"
print_color "yellow" "  home-manager switch --flake 'github:linuxmobile/kaku#linudev@aesthetic'"
print_color "yellow" "=====================================================\n"

read -p "Press Enter to reboot, or Ctrl+C to skip reboot..."
reboot
